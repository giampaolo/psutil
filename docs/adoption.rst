...
packages depending on it. Below is a non-exhaustive list of notable projects
that use psutil.

Tier 1 (>40k GitHub stars)
--------------------------
...
.. list-table::
   ...
   * - |tensorflow-logo| `TensorFlow <https://github.com/tensorflow/tensorflow>`__
     ...
     - |tensorflow-stars|
     -
   * - |sd-webui-logo| `Stable Diffusion WebUI <https://github.com/AUTOMATIC1111/stable-diffusion-webui>`__
   ...
   * - |rich-logo| `Rich <https://github.com/Textualize/rich>`__
     ...
     - |rich-stars|
     -
   * - |autogen-logo| `Microsoft AutoGen <https://github.com/microsoft/autogen>`__
     - Programming framework for agentic AI
     - |autogen-stars|
     -
   * - |faceswap-logo| `Faceswap <https://github.com/deepfakes/faceswap>`__
     - Deepfakes software
     - |faceswap-stars|
     -
   ...
   * - |airflow-logo| `Apache Airflow <https://github.com/apache/airflow>`__
     ...
     - |airflow-stars|
     -
   * - |streamlit-logo| `Streamlit <https://github.com/streamlit/streamlit>`__
     - Build and share data apps in Python
     - |streamlit-stars|
     -
   * - |sentry-logo| `Sentry <https://github.com/getsentry/sentry>`__
     ...
     - |sentry-stars|
     -
   * - |spark-logo| `Apache Spark <https://github.com/apache/spark>`__
     - Unified analytics engine for large-scale data processing
     - |spark-stars|
     -
   * - |mitmproxy-logo| `mitmproxy <https://github.com/mitmproxy/mitmproxy>`__
     - Interactive TLS-capable intercepting HTTP proxy
     - |mitmproxy-stars|
     -
   * - |gradio-logo| `Gradio <https://github.com/gradio-app/gradio>`__
     - Build and share ML apps in Python
     - |gradio-stars|
     -
...
.. list-table::
   ...
   * - |detectron2-logo| `Detectron2 <https://github.com/facebookresearch/detectron2>`__
     - Object detection and segmentation by Facebook
     - |detectron2-stars|
     -
   ...
   * - |optuna-logo| `Optuna <https://github.com/optuna/optuna>`__
     ...
     - |optuna-stars|
     -
   * - |jupyter-logo| `Jupyter Notebook <https://github.com/jupyter/notebook>`__
   ...
   * - |pyinstaller-logo| `PyInstaller <https://github.com/pyinstaller/pyinstaller>`__
     ...
     - |pyinstaller-stars|
     -
   * - |numba-logo| `Numba <https://github.com/numba/numba>`__
     - NumPy-aware dynamic Python compiler using LLVM
     - |numba-stars|
     -
   * - |wandb-logo| `Weights & Biases <https://github.com/wandb/wandb>`__
     - AI developer platform
     - |wandb-stars|
     -
   * - |cython-logo| `Cython <https://github.com/cython/cython>`__
     - Python-to-C compiler
     - |cython-stars|
     -
   * - |modin-logo| `Modin <https://github.com/modin-project/modin>`__
     - Scale Pandas workflows by changing one line of code
     - |modin-stars|
     -
   * - |bpytop-logo| `bpytop <https://github.com/aristocratos/bpytop>`__
     ...
     - |bpytop-stars|
     - core dependency for all metrics
   * - |bashtop-logo| `bashtop <https://github.com/aristocratos/bashtop>`__
...
.. list-table::
   ...
   * - Project
     ...
     - Stars
     - psutil usage
   * - |conan-logo| `Conan <https://github.com/conan-io/conan>`__
     - C/C++ package manager
     - |conan-stars|
     -
   ...
   * - |joblib-logo| `Joblib <https://github.com/joblib/joblib>`__
     - Parallelism and caching for Python functions
     - |joblib-stars|
     -
   * - |xpra-logo| `Xpra <https://github.com/Xpra-org/xpra>`__
   ...
   * - |psdash-logo| `psdash <https://github.com/Jahaja/psdash>`__
     ...
     - |psdash-stars|
     - core dependency for all metrics
   * - |scons-logo| `SCons <https://github.com/SCons/scons>`__
     - Software construction tool
     - |scons-stars|
     -
   * - |diamond-logo| `Diamond <https://github.com/python-diamond/Diamond>`__
