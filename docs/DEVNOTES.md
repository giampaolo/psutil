...
- **netstat, ifconfig**: https://github.com/apple-oss-distributions/network_cmds
...
- **procstat**: https://github.com/freebsd/freebsd-src/tree/main/usr.bin/procstat
...
- **swapinfo**: https://github.com/freebsd/freebsd-src/tree/main/usr.sbin/swapinfo
