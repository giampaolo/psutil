...
class PosixSpecificTestCase(unittest.TestCase):
    ...
    def test_process_rss_memory(self):
        ...
        time.sleep(0.1)
        rss_ps = sh("ps h -o rss -p %s" %self.pid)
