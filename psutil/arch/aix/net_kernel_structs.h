 ...
 * structs we read to be defined with 64 bit "pointers". Here are the partial
 * definitions of the structs we use, taken from the header files, with data type
 * sizes converted to their 64 bit counterparts, and unused data truncated. */
