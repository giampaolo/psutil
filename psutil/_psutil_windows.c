...
PsutilMethods[] =
{
    ...
    {"get_proc_username", psutil_proc_username, METH_VARARGS,
    ...
    {"get_proc_memory_maps", psutil_proc_memory_maps, METH_VARARGS,
     "Return a list of process's memory mappings"},
    {"get_ppid_map", psutil_ppid_map, METH_VARARGS,
     "Return a {pid:ppid, ...} dict for all running processes"},

    // --- alternative pinfo interface
    {"get_proc_cpu_times_2", psutil_proc_cpu_times_2, METH_VARARGS,
     "Alternative implementation"},
    {"get_proc_create_time_2", psutil_proc_create_time_2, METH_VARARGS,
     "Alternative implementation"},
    {"get_proc_num_handles_2", psutil_proc_num_handles_2, METH_VARARGS,
     "Alternative implementation"},
    {"get_proc_io_counters_2", psutil_proc_io_counters_2, METH_VARARGS,
     "Alternative implementation"},
    {"get_proc_memory_info_2", psutil_proc_memory_info_2, METH_VARARGS,
     "Alternative implementation"},
    ...
    {"get_disk_usage", psutil_disk_usage, METH_VARARGS,
     "Return path's disk total and free as a Python tuple."},
