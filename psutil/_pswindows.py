    ...
    def create_time(self, fast_only=False):
        ...
        try:
            ...
            if is_permission_err(err):
                ...
                return self._proc_oneshot()[pinfo_map['create_time']]
            raise

    @wrap_exceptions
    def num_threads(self):
        return self._proc_oneshot()[pinfo_map['num_threads']]
    ...
    def num_handles(self):
        try:
            ...
            if is_permission_err(err):
                ...
                return self._proc_oneshot()[pinfo_map['num_handles']]
            raise

    @wrap_exceptions
    def num_ctx_switches(self):
        ctx_switches = self._proc_oneshot()[pinfo_map['ctx_switches']]
