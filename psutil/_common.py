...
ntuple_diskiostat = namedtuple('iostat', 'name reads writes read_bytes write_bytes read_time write_time')
ntuple_tot_diskiostat = namedtuple('iostat', 'reads writes read_bytes write_bytes read_time write_time')
