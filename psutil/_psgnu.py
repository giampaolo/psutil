...
"""GNU platform implementation. (mostly a copy of Linux one)"""
...
from . import _psutil_gnu as cext
...
# socket.AF_PACKET does not exist on GNU platform
AF_LINK = None
...
def swap_memory():
    ...
    try:
        ...
        _, _, _, _, total, free, unit_multiplier = cext.gnu_meminfo()
